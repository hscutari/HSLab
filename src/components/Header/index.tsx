...
const Header = () => {
  ...
  const options = [
    { label: tCommon("categories.all"), value: "0" },
    { label: tCommon("categories.desktop"), value: "1" },
    { label: tCommon("categories.laptop"), value: "2" },
    { label: tCommon("categories.monitor"), value: "3" },
    { label: tCommon("categories.phone"), value: "4" },
    { label: tCommon("categories.watch"), value: "5" },
    { label: tCommon("categories.mouse"), value: "6" },
    { label: tCommon("categories.tablet"), value: "7" },
  ];
                  ...
                  {menuData.map((menuItem, i) =>
                    menuItem.submenu ? (
                      ...
                      >
                        ...
                        >
                          {menuItem.titleKey ? tMenu(menuItem.titleKey) : menuItem.title}
                        </Link>
                      </li>
                    )
                  )}
